...
import {bindClick, clickBling} from '../../utils/core'

export default Layer.extend({
  ctor(niuniu, niuniu_on, niuniu_off, _13shui, _13shui_on, _13shui_off, resume, resume_on, resume_off, enter, enter_on, enter_off, game_btn_bg) {
    this._super()
    this.niuniu_btn = new MenuItemImage(niuniu, niuniu_on, niuniu_off, () => {
      clickBling()
      this.parent.onClickNiuNiu()
    }, this)
    this._13shui_btn = new MenuItemImage(_13shui, _13shui_on, _13shui_off, () => {
      clickBling()
      this.parent.onClick13Shui()
    }, this)
    ...
    this.enter_room_btn = new MenuItemImage(enter, enter_on, enter_off, () => {
      clickBling()
      this.parent.onClickEnterRoom()
    }, this)
    this.enter_room_btn.setPosition(size.width / 2 + 390, size.height / 2 + 100)
    this.resume_room_btn = new MenuItemImage(resume, resume_on, resume_off, () => {
      clickBling()
      this.parent.onClickResumeRoom()
    }, this)
