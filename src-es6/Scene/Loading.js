...
export const preload = (resources, cb, target) => {
  let loadingScene = new LoadingScene(resources, cb, target)
  cc.director.runScene(new cc.TransitionFade(0.33, loadingScene))
  return loadingScene
}
